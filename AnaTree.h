...
// Wed Dec  7 23:25:58 2016 by ROOT version 6.06/06
// from TTree Delphes/Analysis tree
// found on file: ../MG5_pp_hh_13TeV_10M_py8_Forced_4900000_to_5000000.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../MG5_pp_hh_13TeV_10M_py8_Forced_4900000_to_5000000.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../MG5_pp_hh_13TeV_10M_py8_Forced_4900000_to_5000000.root");
      }
